; Lavrentiy.iss — Inno Setup installer for v1.7.3 (drift-proof bundling).
;
...
;        -> Produces installer\Output\Lavrentiy-Setup-v1.7.3.exe
;
; INSTALL TARGET:
...
OutputDir=Output
OutputBaseFilename=Lavrentiy-Setup-v1.7.3
...
; User-entered keys in v1.7.1 live under %USERPROFILE%\.lavrentiy instead.
