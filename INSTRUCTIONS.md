...
Click `Lavrentiy-Setup-v1.7.4.exe`. The installer is large because it includes the local English speech-recognition model.
...
1. Double-click `Lavrentiy-Setup-v1.7.4.exe`.
...
Make sure you're on **v1.7.4 or newer**.

If you're on v1.7.4 and still see an empty profile after sign-in:
